...
const Navbar = () => {
  ...
  const academicsInstitutes = {
    "Main Campus - Wardha": [
      ...
      },
      {
        ...
        to: "https://www.dmiher.edu.in/about-srmmcon",
      },
      {
      ...
      },
      {
        ...
        to: "https://www.dmiher.edu.in/About-SMCON-Wardha",
      },
      {
        label: "SHER",
        to: "https://www.dmiher.edu.in/about-shper",
      },
    ],
    "Off Campus - Wanadongri, Nagpur": [
      ...
      {
        label: "Shalinitai Meghe College of Nursing",
        to: "https://www.dmiher.edu.in/about-smcon-nagpur",
      },
      {
        label:
  ...
  const topLinks = [
    {
      // to: "https://www.dmiher.edu.in/lp/national-admission",
      to: "/admissions",
      label: "Admissions",
    },
  ...
  return (
    <div className="fixed w-full bg-white top-[-1px] left-0 z-100 shadow-sm h-[101px] xl:h-[101px]">
      <div className="flex justify-between items-center px-4 xl:px-6 py-3 pb-0 xl:ml-20 xl:mr-20 ml-0 mr-0 h-full">
        ...
        <div className="hidden xl:flex flex-col items-end space-y-2 justify-end h-full gap-1">
          ...
          <div className="flex gap-10 text-[#1f3c88] text-[18px]">
            {navLinks.map((link) => {
              if (link.isDropdown && link.label === "Academics") {
                return (
                  <div
                  ...
                  >
                    ...
                    {showDropdown && (
                      <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-3 flex bg-white text-[#1f3c88] border shadow-lg p-4 z-50 w-[600px] justify-between">
                            ...
                            <div key={campus} className="w-1/2 px-4">
                              ...
                              <ul className="space-y-1">
                                {institutes.map((inst) => (
                                  ...
                                  >
                                    <div className="w-[6px] h-[6px] rounded-full bg-[#1f3c88] mt-[6px] min-w-[6px]" />
                                    {inst.to.startsWith("/") ? (
                                      <Link
                                        to={inst.to}
...
//         link: "https://www.dmiher.edu.in/about-jnmc",
//       },
//       {
//         name: "Sharad Pawar Dental College and Hospital",
//         link: "https://www.dmiher.edu.in/about-spdc",
//       },
//       {
//         name: "Mahatma Gandhi Ayurvedic College Hospital and Research Centre",
//         link: "https://www.mgachrc.org/",
//       },
//       {
//         name: "Smt Radhikabai Meghe Memorial College of Nursing",
//         link: "https://www.dmiher.edu.in/about-srmmcon",
//       },
//       {
//         name: "Ravi Nair Physiotherapy College",
//         link: "https://www.dmiher.edu.in/about-rnpc",
//       },
//       {
//         name: "Datta Meghe College of Pharmacy",
//         link: "https://www.dmcopwardha.com/",
//       },
//       { name: "Faculty of Engineering and Technology", link: "/feat" },
//       {
//         name: "School of Allied Sciences",
//         link: "https://www.dmiher.edu.in/about-sas",
//       },
//       {
//         name: "Centre for Distance and Online Education",
//         link: "https://www.dmiheronline.edu.in/",
//       },
//       {
//         name: "School of Allied Health Sciences",
//         link: "https://www.dmiher.edu.in/about-sahes",
//       },
//       {
//         name: "Shalinitai Meghe College of Nursing",
//         link: "https://www.dmiher.edu.in/About-SMCON-Wardha",
//       },
//       { name: "SHER", link: "https://www.dmiher.edu.in/about-shper" },
//     ],
//     "Off Campus - Wanadongri, Nagpur": [
//       {
//         name: "Datta Meghe Medical College",
//         link: "https://www.dmmcnagpur.com/",
//       },
//       {
//         name: "School of Allied Health Sciences",
//         link: "https://www.dmiher.edu.in/school-of-allied-health-sciences-nagpur-a-constituent-unit-of-dmiher",
//       },
//       {
//         name: "Shalinitai Meghe College of Nursing",
//         link: "https://www.dmiher.edu.in/about-smcon-nagpur",
//       },
//       {
//         name: "Shalinitai Meghe Homeopathy Hospital College and Research Centre",
//         link: "https://smhhcrc.com/",
//       },
//     ],
//   };
...
//             {topLinks.map((link, index) => {
//               const isExternal = link.to.startsWith("http");
//               const isAdmissions = link.label === "Admissions";
//               const commonClasses = `hover:underline pr-3 whitespace-nowrap ${
//                 !isExternal && isActive(link.to)
//                   ? "border-b-[2px] border-[#ff4f37] text-[#ff4f37]"
//                   : ""
//               } ${index < 2 ? "border-r-2 border-[#707070]" : ""} ${
//                 isAdmissions ? "text-[#ff4f37] font-bold color-pulse" : ""
//               }`;
...
//                   : ""
//               } ${
//                 isAdmissions ? "text-[#ff4f37] font-bold blink-animation" : ""
//               }`;
