...
const slides = [
  {
    ...
    paragraph: `Hands-On Nursing Training from Primary Care to<br/> Super Speciality with 3000+ Bedded Hospitals`,
    textPosition: "left",
  },
  {
    img: NursingBanner2,
    ...
    paragraph:
      "Advanced Skill Labs, OSCE Training, High-Fidelity Mannequins<br/> & Specialized Maternal Health Labs",
    textPosition: "right",
  },
  {
    img: NursingBanner3,
    ...
    <div className="relative w-full h-[90vh] overflow-hidden">
      ...
      text-white sm:w-1/2 w-[60%] lg:w-[50%] max-w-none z-20`}
            >
              <h1
                className={`text-5xl text-left font-oswald-medium font-[500] leading-[1.1]  max-w-[490px] ${
                  slide.textPosition === "right" ? "lg:ml-40" : ""
                } `}
              >
                {slide.title}
                {idx != 1 ? <br /> : null}
