...
// // smcon wardha
// import SMW1 from "../../assets/Nursing/StudentLife/smw1.jpg";
// import SMW2 from "../../assets/Nursing/StudentLife/smw2.jpg";
// import SMW3 from "../../assets/Nursing/StudentLife/smw3.jpg";
// import SMW4 from "../../assets/Nursing/StudentLife/smw4.jpg";
// import SMW5 from "../../assets/Nursing/StudentLife/smw5.jpg";
// import SMW6 from "../../assets/Nursing/StudentLife/smw6.jpg";
// import SMW7 from "../../assets/Nursing/StudentLife/smw7.jpg";
// import SMW8 from "../../assets/Nursing/StudentLife/smw8.jpg";
...
//   useEffect(() => {
//     const selectedSlides = contentByCollege[collegeTabNumber] || [];
//     setSlides(selectedSlides);
//     sliderRef.current?.slickGoTo(0); // Reset slider
//   }, [collegeTabNumber]);
...
function StudentLifeNursing({ collegeTabNumber }) {
  ...
  const contentByCollege = {
    ...
    2: [
      { title: "Yoga for one Earth one Health", image: SMW1 },
      { title: "Yoga for one Earth one Health", image: SMW2 },
      { title: "Yoga for one Earth one Health", image: SMW3 },
      { title: "Yoga for one Earth one Health", image: SMW4 },
      { title: "Yoga for one Earth one Health", image: SMW5 },
      { title: "Yoga for one Earth one Health", image: SMW6 },
      { title: "Yoga for one Earth one Health", image: SMW7 },
      { title: "Yoga for one Earth one Health", image: SMW8 },
    ],
    3: [
      { title: "Co-Curricular Activities", image: CoCurricularImg1 },
      { title: "Christmas Day", image: CoCurricularImg2 },
