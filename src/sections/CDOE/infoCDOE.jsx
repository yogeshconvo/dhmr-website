...
<<<<<<< HEAD
      <div className="py-12 px-4">
        ...
        <section className="bg-white text-center text-sm mx-auto max-w-7xl px-2 sm:px-4">
          {/* Main Heading */}
          <h1 className="text-2xl uppercase sm:text-3xl md:text-4xl font-[500] font-oswald-medium text-[#58595B] leading-snug mb-6">
          ...
          <div className="text-[#58595B] font-[Arial] tracking-wide  max-w-4xl mx-auto">
            <p className="mb-4">
              CDOE empowers learners with the flexibility to pursue
              high-quality, UGC-entitled education at their own pace. Backed by
              DMIHER (Deemed to be University), a UGC-recognized institution
              since 2005 and compliant with Section 12B of the UGC Act, CDOE
              began offering its online programs in July 2020. These programs
              are designed to deliver the academic robustness of traditional
              classroom learning, while offering the convenience of self-paced,
              schedule-free access.
            </p>

            <p className="mb-4 tracking-wide  font-[Arial]">
              Through real-time interactive classes, access to digital learning
              platforms, and personalized mentorship, students engage in a
              learning experience that’s not just convenient—but deeply
              enriching and future-ready.
            </p>
          </div>
        </section>
      </div>
