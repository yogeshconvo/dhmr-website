    ...
    <div className="py-12 px-4">
      ...
      <section className="bg-white text-center text-sm mx-auto max-w-7xl px-2 sm:px-4">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-[500] font-oswald-medium text-[#58595B] leading-snug mb-6">
          Empowering Minds Through Health Technology, Arts and Leadership Management
        </h1>
        ...
        <div className="text-[#58595B] font-[Arial] tracking-wide max-w-4xl mx-auto">
          <p className="mb-4">
            ...
            blend of management, technology, and healthcare education. SAS houses
            three faculties: Faculty of Commerce & Management Sciences, Faculty of
            Science & Technology, and Faculty of Liberal Arts, Humanities & Social
            Sciences, providing 04 UG, 06 PG, and 05 PhD programs preparing
            students for careers at the intersection of health, technology, and
            leadership.
          </p>
          ...
          <p className="mb-4">
            ...
            healthcare knowledge to develop innovative professionals for a rapidly
            evolving world.
          </p>

          <p className="mb-4">
            Equipped with state-of-the-art infrastructure, industry-driven
            learning, and expert faculty, SAS emphasizes teamwork, collaboration,
            and hands-on experience to ensure students are globally competitive.
            Affiliated with DMIHER (DU), a NAAC A++ accredited university, SAS
            provides high-quality education and healthcare leadership training,
