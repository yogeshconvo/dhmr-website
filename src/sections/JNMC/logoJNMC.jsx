  ...
  return (
    <>
      <div className=" mx-auto py-10 bg-gray-100">
        {/* Buttons */}
        <div className="flex flex-wrap font-oswald-medium justify-center gap-10 mb-15">
          <button className="bg-[#F04E30] text-white text-base sm:text-xl font-medium px-7 sm:px-8 py-3 min-w-[230px] rounded-md shadow-[4px_6px_10px_rgba(0,0,0,0.2)]">
            Transcripts – UG & PG
          </button>
          <button className="bg-[#102B64] text-white text-base sm:text-xl px-6 sm:px-8 py-2 min-w-[230px] rounded-md shadow-[4px_6px_10px_rgba(0,0,0,0.2)]">
            Electives Offered
          </button>
        </div>
