  ...
  return (
    <div className="bg-[#FAF8F0] px-6 md:px-40 py-20">
      <div className="mx-auto">
        ...
        <p className="text-base text-gray-500 font-[400] max-w-3xl">
          Jawaharlal Nehru Medical College (JNMC) shapes healthcare leaders who
          excel in higher education and global healthcare careers. Backed by
          state-of-the-art facilities and global collaborations, JNMC graduates
          become clinicians, educators, and researchers at national and
      ...
      <div className="max-w-7xl mx-auto mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 font-oswald-medium">
        ...
        <div className="text-[#58595B] text-2xl font-[300] px-4">
          ...
          <span className="text-[#102B64] font-bold">
            14% selection into super-specialty courses, PhDs, postdoctoral
