...
function InfrastrucureFC() {
  ...
  return (
    <section className="bg-white px-2 sm:px-4 md:px-10 py-8 sm:py-8 md:py-16 font-oswald-medium container">
...
export default InfrastrucureFC;
