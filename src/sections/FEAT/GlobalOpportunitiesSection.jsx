...
//             Global Opportunities <br /> at FEAT
//           </h2>
...
//         {/* Logo Grid with balanced borders */}
//         <div className="grid grid-cols-2 sm:grid-cols-4 gap-y-8 items-center justify-items-stretch">
//           {logos.map((logo, idx) => (
//             <div
//               key={idx}
//               className={`flex justify-center items-center max-h-20 px-4 ${
//                 // apply border to all except last item in each row
//                 (idx + 1) % 4 !== 0 ? "border-r border-gray-300" : ""
//               }`}
//             >
//               <img
//                 src={logo.src}
